...
exports.patchStaleEdges = patchStaleEdges;
/**
...
function patchStaleEdges(graph, changedFiles) {
    ...
    const maxInbound = Math.max(1, ...Object.values(graph.relationships).map((r) => r.dependedOnBy.length));
